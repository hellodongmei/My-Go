...
num_games_onecpu = 8    # -a parameter
num_steps_search = 1000  # -b parameter
...
if os.path.exists(agent_path):
    ...
    for i in range(0, num_cpus_request):
        ...
        running_comand = 'srun python %s -a %d -b %d -c %s -d %d %s %s' % (python_path, num_games_onecpu, num_steps_search, exp_path, i+1, duplicate_agent, duplicate_agent)
