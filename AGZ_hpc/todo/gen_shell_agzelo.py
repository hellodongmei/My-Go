...
num_games_onecpu = 15    # -g parameter
num_games_boards = 9      # -b parameter

agent_path = '/home/users/l/liudong1/scratch/AGZ/agents'

# where the error and output information of the gpu cores to be stored
std_path = '/home/users/l/liudong1/scratch/AGZ/std_elo'
...
shell_path = '/home/users/l/liudong1/scratch/AGZ/shells/elo'

"""
#!/bin/sh

#SBATCH --cpus-per-task=1
#SBATCH --job-name=agzelo
...
#SBATCH --error=/home/users/l/liudong1/scratch/AGZ/std_elo/run_agz_elo_1.err
#SBATCH --output=/home/users/l/liudong1/scratch/AGZ/std_elo/run_agz_elo_1.out
...
srun python /home/users/l/liudong1/workspace/AGZ_hpc/calc_elo_ratings.py -g 100 -b 9 /home/users/l/liudong1/scratch/AGZ/agents/agent_zero_1.h5 /home/users/l/liudong1/scratch/AGZ/agents/agent_zero_0.h5 
...
python_path = '/home/users/l/liudong1/workspace/AGZ_hpc/calc_elo_ratings.py'
...
if os.path.exists(agent_path):
    ...
    for i in range(0, agent_generation):
        ...
        agent_zero_0 = '%s/agent_zero_%d.h5' % (agent_path, 0)
        agent_zero_x = '%s/agent_zero_%d.h5' % (agent_path, i+1)

        agent_zero_0x =  '%s/agent_zero_%d_%d.h5' % (agent_path, 0, i+1)
        ...
        write_logfile(shell_name, '#SBATCH --job-name=agzelo')
        ...
        running_comand = 'srun python %s -g %d -b %d %s %s' % (python_path, num_games_onecpu, num_games_boards, agent_zero_x, agent_zero_0x)
