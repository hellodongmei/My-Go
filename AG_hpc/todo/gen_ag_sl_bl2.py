...
agent_path = '/home/users/l/liudong1/scratch/AG/agents/sl_bl2'  # -c parameter
history_path = '/home/users/l/liudong1/scratch/AG/history'      # -d parameter

# where the error information of the cpu cores to be stored
err_path = '/home/users/l/liudong1/scratch/AG/stderr/sl_bl2'
if not os.path.exists(err_path):
    os.makedirs(err_path)

# where the print information of the cpu cores to be stored
out_path = '/home/users/l/liudong1/scratch/AG/stdout/sl_bl2'
...
shell_path = '/home/users/l/liudong1/scratch/AG/shells/sl_bl2'
...
python_path = '/home/users/l/liudong1/workspace/AG_hpc/ag_sl_bl2.py'
