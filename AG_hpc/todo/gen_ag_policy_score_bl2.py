...
score_path = '/home/users/l/liudong1/scratch/AG/score/combine_17'       # -a parameter
agent_path = '/home/users/l/liudong1/scratch/AG/score_agent/agents_score'# -b parameter


# where the error information of the cpu cores to be stored
err_path = '/home/users/l/liudong1/scratch/AG/stderr/err_score'

# where the print information of the cpu cores to be stored
out_path = '/home/users/l/liudong1/scratch/AG/stdout/out_score'
...
python_path = '/home/users/l/liudong1/workspace/AG_hpc/score_ag_policy_bl2.py'


shell_name =  '%s/run_ag_score_bl2.sh' % shell_path
...
write_logfile(shell_name, '#SBATCH --job-name=agpolicyscbl2')
