...
shell_path = '/home/users/l/liudong1/scratch/AG/shells/elo/neighbor'
...
if os.path.exists(agent_path):
    ...
    for i in range(0, agent_generation):
        ...
        if i==0:
            agent_zero_opponent = '%s/sl_policy_%d.h5' % (agent_path, 0)
        else:
            agent_zero_opponent = '%s/rl_policy_%d.h5' % (agent_path, i)
        ...
        running_comand = 'srun python %s -g %d -b %d -c %d -d %s %s %s' % (python_path, num_games_onecpu, num_games_boards, agent_id, score_path, agent_zero_x, agent_zero_opponent)
