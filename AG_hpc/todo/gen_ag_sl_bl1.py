...
err_path = '/home/users/l/liudong1/scratch/AG/stderr/sl_bl1'

# where the print information of the cpu cores to be stored
out_path = '/home/users/l/liudong1/scratch/AG/stdout/sl_bl1'

# where do we store the shell scripts
shell_path = '/home/users/l/liudong1/scratch/AG/shells/sl_bl1'

"""
#!/bin/sh

#SBATCH --cpus-per-task=1
#SBATCH --job-name=agslbl1
#SBATCH --time=12:00:00
#SBATCH --gpus=1
##SBATCH --constraint="V5|V6"
#SBATCH --partition=shared-gpu

#SBATCH --error=/home/users/l/liudong1/scratch/AG/stderr/sl_bl1/run_ag_sl_bl1.err 
#SBATCH --output=/home/users/l/liudong1/scratch/AG/stdout/sl_bl1/run_ag_sl_bl1.out
...
srun cd /home/users/l/liudong1/workspace/AG_hpc
srun python /home/users/l/liudong1/workspace/AG_hpc/ag_sl_bl1.py -a 6570
...
python_path = '/home/users/l/liudong1/workspace/AG_hpc/ag_sl_bl1.py'
...
write_logfile(shell_name, '#SBATCH --job-name=agslbl1')
