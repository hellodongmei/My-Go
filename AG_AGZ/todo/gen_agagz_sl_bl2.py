...
agent_path = '/home/users/l/liudong1/scratch/AG_AGZ/agents'  # -c parameter
history_path = '/home/users/l/liudong1/scratch/AG_AGZ/history/hist_minus4to1'      # -d parameter

# where the error information of the cpu cores to be stored
err_path = '/home/users/l/liudong1/scratch/AG_AGZ/stderr/sl_bl2_minus4to1'
if not os.path.exists(err_path):
    os.makedirs(err_path)

# where the print information of the cpu cores to be stored
out_path = '/home/users/l/liudong1/scratch/AG_AGZ/stdout/sl_bl2_minus4to1'
...
#SBATCH --error=/home/users/l/liudong1/scratch/AG_AGZ/stderr/sl_bl2_minus4to1/run_ag_sl_bl2_lr_bs.err 
#SBATCH --output=/home/users/l/liudong1/scratch/AG_AGZ/stdout/sl_bl2_minus4to1/run_ag_sl_bl2_lr_bs.out
...
srun python /home/users/l/liudong1/workspace/AG_AGZ/agagz_sl_bl2.py -b 0.1 -c /Users/ldm/Documents/masterthesis/code_9/AG_AGZ/agents -d //Users/ldm/Documents/masterthesis/code_9/AG_AGZ/history -e 128
current_date_time="`date "+%Y-%m-%d %H:%M:%S"`"
srun echo "Finished on $current_date_time."
"""

env_path = '/home/users/l/liudong1/workspace/AG_AGZ/set_env.sh'
python_path = '/home/users/l/liudong1/workspace/AG_AGZ/agagz_sl_bl2.py'
...
for i in range(0, num_of_bins_lr):
    for j in range(0, num_of_bins_bs):
        ...
        write_logfile(shell_name, '#SBATCH --job-name=ag_agzslbl2')
