...
def compute_game_result(game_state):
    ...
    capture = game_state.board._capt
    return GameResult(
        territory.num_black_territory + territory.num_black_stones + capture['black'],
        territory.num_white_territory + territory.num_white_stones + capture['white'],
        komi=7.5)
