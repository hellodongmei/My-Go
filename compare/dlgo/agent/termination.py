...
# tell the agent pass when the opponent pass and resign when going to be lose the game
...
class TerminationStrategy:
    ...
    def should_resign(self, game_state):
        return False
        # return ResignLargeMargin.should_resign(game_state)

# end::termination_strategy[]


# tag::opponent_passes[]
# a simple heuristic for stopping game play is to pass when the opponent passes
