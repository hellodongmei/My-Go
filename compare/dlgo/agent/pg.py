...
def policy_gradient_loss(y_true, y_pred):
    ...
    # k.clip returns a tensor
    loss = -1 * y_true * K.log(clip_pred) # cross-entropy
...
class PolicyAgent(Agent):
    ...
    def select_move(self, game_state):
        if len(game_state.board._grid) > 70:
    ...
    def train(self, experience, lr=0.0000001, clipnorm=1.0, batch_size=512):
        ...
        train_gen = DataGenerator(experience.states, y, batch_size)
