...
score_path = '/home/users/l/liudong1/scratch/compare/score/agz_agzsl_3' # -d parameter
if not os.path.exists(score_path):
    os.makedirs(score_path)
#                     -d parameter 

agent = '/home/users/l/liudong1/scratch/compare/agents/agent_zero_3.h5' 
opponent = '/home/users/l/liudong1/scratch/compare/agents/ag_agz.h5' 
...
err_path = '/home/users/l/liudong1/scratch/compare/stderr/err_agz_agzsl_3' 
if not os.path.exists(err_path):
    os.makedirs(err_path)

# where the print information of the cpu cores to be stored
out_path = '/home/users/l/liudong1/scratch/compare/stdout/out_agz_agzsl_3' 
...
shell_path = '/home/users/l/liudong1/scratch/compare/shells/score_agz_agzsl_3'
...
if os.path.exists(agent_path):
    ...
    for i in range(0, num_cpus_request):
        ...
        duplicate_opponent = opponent.replace('.h5', '_agz_3_%d.h5' % (i+1) )
        ...
        write_logfile(shell_name, '#SBATCH --job-name=agz3agzsl')
