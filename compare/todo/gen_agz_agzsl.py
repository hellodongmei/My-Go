...
score_path = '/home/users/l/liudong1/scratch/compare/score/agz_agzsl' # -d parameter
if not os.path.exists(score_path):
    os.makedirs(score_path)
#                     -d parameter 

agent = '/home/users/l/liudong1/scratch/compare/agents/agent_zero_0.h5' 
...
err_path = '/home/users/l/liudong1/scratch/compare/stderr/err_agz_agzsl' 
if not os.path.exists(err_path):
    os.makedirs(err_path)

# where the print information of the cpu cores to be stored
out_path = '/home/users/l/liudong1/scratch/compare/stdout/out_agz_agzsl' 
...
shell_path = '/home/users/l/liudong1/scratch/compare/shells/score_agz_agzsl'
