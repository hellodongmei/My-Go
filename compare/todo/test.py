...
err_path = '/home/users/l/liudong1/scratch/compare/stderr/err_ag0_agagz_test' 
if not os.path.exists(err_path):
    os.makedirs(err_path)

# where the print information of the cpu cores to be stored
out_path = '/home/users/l/liudong1/scratch/compare/stdout/out_ag0_agagz_test' 
...
shell_path = '/home/users/l/liudong1/scratch/compare/shells/score_agagz_ag0_test'
if not os.path.exists(shell_path):
    os.makedirs(shell_path)


env_path = '/home/users/l/liudong1/workspace/compare/set_env.sh'
python_path = '/home/users/l/liudong1/workspace/comparetest.py'
