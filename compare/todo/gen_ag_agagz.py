...
score_path = '/home/users/l/liudong1/scratch/compare/score/ag_agagz' # -d parameter
if not os.path.exists(score_path):
    os.makedirs(score_path)
#     -d parameter 

strong_policy = '/home/users/l/liudong1/scratch/compare/agents/rl_policy_10.h5'
...
err_path = '/home/users/l/liudong1/scratch/compare/stderr/err_ag_agagz' 
if not os.path.exists(err_path):
    os.makedirs(err_path)

# where the print information of the cpu cores to be stored
out_path = '/home/users/l/liudong1/scratch/compare/stdout/out_ag_agagz' 
...
shell_path = '/home/users/l/liudong1/scratch/compare/shells/score_ag_agagz'
if not os.path.exists(shell_path):
    os.makedirs(shell_path)


env_path = '/home/users/l/liudong1/workspace/compare/set_env.sh'
python_path = '/home/users/l/liudong1/workspace/compare/b_v_b_ag_agagz_hpc.py'
...
if os.path.exists(agent_path):
    ...
    for i in range(0, num_cpus_request):
        ...
        shell_name =  '%s/run_ag_agagz_compare_%d.sh' % (shell_path, i+1)
        ...
        write_logfile(shell_name, '#SBATCH --job-name=ag_agagz')
